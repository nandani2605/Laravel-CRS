...
class CarList extends Model
{
    ...
    protected $fillable = [
        ...
        'mileage_limit', 'how_to_book', 'car_img'
    ];

    public function createCarList(array $validatedData, $imagePath)
    {
        try {
            return $this->create([
            ...
            Log::error('[CarList][createCarList] Error creating car list: ' . $e->getMessage());
            return null; // Ensure you return null or handle this case appropriately
        }
    }
